...
namespace FrontendAutomatedTests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("DeleteScenarios")]
    public partial class DeleteScenariosFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "DeleteScenarios", "Covered Scenarios :\r\n- Create and Delete New Board Through Frontend UI", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
#line 17
 testRunner.And("the user can verify that the board no longer exists", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
